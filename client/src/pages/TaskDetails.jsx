...
  if (error || !task) return <div className='text-red-600'>{error || "Task not found"}</div>;
...
                          </span>
                          <span className='px-2 py-0.5 rounded-full bg-violet-200 text-violet-800 font-semibold'>
                            {el?.tag}
                          </span>
                        </div>
...
                    src={el}
                    alt={`asset-${index}`}
                    className='w-full rounded h-28 md:h-36 2xl:h-52 object-cover cursor-pointer hover:scale-105 transition-all duration-300'
                  />
                ))}
              </div>
            </div>
